...
const UbahGallery = () => {
  ...
  const onSubmit = async (values: z.infer<typeof schema>) => {
    try {
      ...
      toast.success("Gambar galeri berhasil diubah");
      navigate("/dashboard/gallery");
    } catch {
      toast.error("Gagal mengubah gambar galeri");
    }
  };
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        form.setValue("judul", res.judul);
        form.setValue("deskripsi", res.deskripsi || "");
        setPreview(res.gambar);
      } catch {
